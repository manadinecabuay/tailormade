...
<body>
  <div class="container">
    <div class="form-wrapper">
      ...
      <h2>🔐 Login</h2>
      <form id="loginForm" method="POST" action="process_unified_login.php">
        ...
        <div style="position: relative;">
          ...
          <button type="button" id="togglePassword" 
              style="position:absolute; right:10px; top:60%; transform:translateY(-50%);
                   background:transparent; border:none; color:#000; font-weight:bold; cursor:pointer;">Show
          </button>
        </div>
  ...
  <script>
    ...
    if (logoutMessage === 'logged_out') {
      showModal('successModal', 'You have been logged out successfully!');
      setTimeout(() => {
    ...
    document.getElementById('loginForm').addEventListener('submit', async (e) => {
      ...
      const response = await fetch('process_unified_login.php', {
        method: 'POST',
        body: formData
      });
